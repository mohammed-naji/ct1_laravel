@extends('creative.app')

@section('title', 'Home Pageeeee')
...
@section('content')
    ...
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed, sit dicta commodi deleniti in aperiam! Adipisci, earum
        quis ipsa molestiae, rerum, voluptatibus dignissimos eaque nihil enim quibusdam impedit nemo dolorem!</p>
    <!-- Call to action-->
